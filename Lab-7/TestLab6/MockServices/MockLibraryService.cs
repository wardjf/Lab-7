...
public class MockLibraryService : ILibraryService
{
    ...
    private readonly string booksFilePath = "C:\\Users\\Josh\\Documents\\GitHub\\Lab-7\\Lab-7\\TestLab6\\MockData\\MockBooks.csv";
    private readonly string usersFilePath = "C:\\Users\\Josh\\Documents\\GitHub\\Lab-7\\Lab-7\\TestLab6\\MockData\\MockUsers.csv";
    ...
    protected virtual List<Book> ReadBooksFromCsv()
    {
    ...
    protected virtual List<User> ReadUsersFromCsv()
    {
    ...
    protected virtual void WriteBooksToCsv()
    {
    ...
    protected virtual void WriteUsersToCsv()
    {
